...
(task {
    ...
    try
        ...
        let reactCheckRateLimiter = new FixedWindowRateLimiter(FixedWindowRateLimiterOptions(1, QueueProcessingOrder.NewestFirst, 20, System.TimeSpan.FromSeconds 2.))
