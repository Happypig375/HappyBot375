...
(task {
    ...
    try
        ...
        let reactRateLimiter = new FixedWindowRateLimiter(FixedWindowRateLimiterOptions(1, QueueProcessingOrder.NewestFirst, 10, System.TimeSpan.FromSeconds 10.))
        ...
        let reactCheckRateLimiter = new FixedWindowRateLimiter(FixedWindowRateLimiterOptions(1, QueueProcessingOrder.NewestFirst, 0, System.TimeSpan.FromSeconds 2.))
